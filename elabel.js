/*
 * Label.js - v3.0.2 - 12/08/2010
 * https://github.com/erunyon/Label
 * 
...
function Label(data) {
   ...
   */
    ...
    this.pixelOffset = data.offset || {"width":0, "height":0};
    if (data.opacity) {
  ...
  Label.prototype.onAdd = function(map) {
  ...
  Label.prototype.setContents = function(html) {
    this.html = html;
  ...
  Label.prototype.setOpacity = function(percentOpacity) {
    if (percentOpacity) {
